<template>
    ...
    <div class="">
        <div class="jumbotron text-white text-center">
            <h2 class="lead display-4"><i class="fab fa-slack"></i><br>SLACKERR</h2>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h3 class="text-center mb-5 display-5"><i class="fa fa-user"></i> Register</h3>
                <form>
                  ...
                  <div class="form-group">
                    <input v-model.trim="password_confirmation" type="password" name="password_confirmation" class="form-control" placeholder="Password confirmation" required>
                  </div>

                  <button @click.prevent="register" type="submit" class="btn form-control registerbtn" v-if="!isLoading">Register</button>
