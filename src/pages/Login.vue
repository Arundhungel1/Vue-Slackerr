<template>
  <div>
    ...
    <div class="col-md-6 offset-md-3">
      <h3 class="text-center mb-5 display-5"><i class="fa fa-user"></i> Login</h3>
      <form>
        ...
        <button @click.prevent="login" type="submit" class="btn btn-lg form-control loginbtn" v-if="!isLoading">Login</button>
